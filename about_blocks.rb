...
class AboutBlocks < Neo::Koan
  def method_with_block
    result = yield      # sets result to the passed in block + executes
    result              # returns the output of the block
  end
  ...
  def test_blocks_can_take_arguments    # calls method and iterates over yields
    method_with_block_arguments do |argument|
      assert_equal "Jim", argument
    end

    # block is passed to method, and used to modify each yield - as per...?
    method_with_block_arguments do |argument|
      argument << "!"
      assert_equal "Jim!", argument
    end
