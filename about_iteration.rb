...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    result3 = ["b","c","d"].inject("a") { |memo, obj| memo + obj }
    assert_equal "abcd", result3
    ...
    #
    # iterates each item in the array, executes the function and passes
    # the output as the 'memo' parameter of the next call
    # 
    # Any value passed to inject added to the start of the array
  end
  ...
  #
  # if you don't pass a block Ruby will try to create a new file,
  # otherwise it will open the file, pass it to the block, then close it
end
